...
tf.app.flags.DEFINE_boolean("line_based", True,
                            "input and output is a single line if set to true.")
tf.app.flags.DEFINE_boolean("skip_thought", False,
                            "apply skip thought.")
...
def train():
  ...
  in_train, out_train, in_dev, out_dev, _, _ = data_utils.prepare_poem_data(
      ...
      FLAGS.line_based, FLAGS.skip_thought)
